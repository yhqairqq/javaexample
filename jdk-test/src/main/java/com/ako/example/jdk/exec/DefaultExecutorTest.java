...
//    private final File wrapperScript = TestUtil.resolveScriptForOS(testDir + "/wrapper");
    ...
    public static void main(String[] args) throws IOException {
        ...
        String commandStr = "echo $JAVA_HOME";

            // hdfs dfs -appendToFile 20170719.csv  hdfs://namenode:8020/user/hive/warehouse/sc_graph_log/
        final CommandLine commandLine = new CommandLine(commandStr);
        ...
        ExecuteResultHandler handler =  new CustomizeExecuteResultHandler(new ExecuteWatchdog(15000));
...
class CustomizeExecuteResultHandler implements  ExecuteResultHandler{
    private ExecuteWatchdog watchdog;

    public CustomizeExecuteResultHandler(final ExecuteWatchdog watchdog) {

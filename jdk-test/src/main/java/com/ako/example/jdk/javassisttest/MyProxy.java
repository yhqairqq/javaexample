...
//
///**
// * Created by yanghuanqing@wdai.com on 17/07/2017.
// */
//public abstract  class MyProxy {
//
//    private static final AtomicLong PROXY_CLASS_COUNTER = new AtomicLong(0);
//
//    private static final String PACKAGE_NAME = MyProxy.class.getPackage().getName();
//
...
//
//    public static MyProxy getProxy(Class<?>... ics)
//    {
//        return getProxy(ClassHelper.getCallerClassLoader(MyProxy.class), ics);
//    }
//
//    public static MyProxy getProxy(ClassLoader cl, Class<?>... ics)
//    {
//        if( ics.length > 65535 )
...
//                {
//                    proxy = (MyProxy)((Reference<?>)value).get();
//                    if( proxy != null )
//                        return proxy;
//                }
//
...
//        String pkg = null;
//        MyClassGenerator ccp = null, ccm = null;
//        try
//        {
//            ccp = MyClassGenerator.newInstance(cl);
//
...
//                    cache.remove(key);
//                else
//                    cache.put(key, new WeakReference<MyProxy>(proxy));
//                cache.notifyAll();
//            }
//        }
//        return proxy;
